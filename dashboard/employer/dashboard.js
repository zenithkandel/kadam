document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadPage(pageUrl, title, linkElement) {
        ...
        // Save state
        sessionStorage.setItem('employer_activePage', pageUrl);
        sessionStorage.setItem('employer_pageTitle', title);
    ...
    // Restore State
    const savedPage = sessionStorage.getItem('employer_activePage');
    const savedTitle = sessionStorage.getItem('employer_pageTitle');
